...
function AudioTest2 ({advanceStage, keyPressed, targetKey, commence, reactionColor, audioType, name, submit, audioReactionTime}) {

    const audioRef1 = useRef();
    const audioRef2 = useRef();
    const [data, setData] = useState([]);
    const [audioDic, setAudioDic] = useState({
        "audioOne": audioRef1,
        "audioTwo": audioRef2
    });
    ...
    const stim = () => {
        ...
        audioDic[audioType].current.play();
    };
